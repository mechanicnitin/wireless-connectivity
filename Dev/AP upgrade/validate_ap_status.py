...
def main():
    ...
    for r in rows:
        ...
        try:
            ...
            if is_pre:
                ...
                eligible_count, eligible_devices, flagged_devices, skip_reason = evaluate_site_post(
    ...
    if skipped == total and total > 0:
        print(f"\n⚠️  WARNING: All {total} site(s) were skipped")
        sys.exit(1)

    if ok > 0:
        print(f"\n✅ SUCCESS: All {ok} site(s) validated")
        sys.exit(0)
